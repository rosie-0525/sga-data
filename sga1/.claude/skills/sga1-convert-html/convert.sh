#!/usr/bin/env bash
# sga1-convert-html: 01-normalized_tex/ -> 02-converted_html/
#
...
BOOK_ROOT="$(cd "$HERE/../../.." && pwd)"        # sga1/ — 01-normalized_tex/, 02-converted_html/ live here
...
# -> sga1 -> super-root), so rewrite the references to ../../translation-viewer/, and
...
echo "          preview with:  (cd \"$SUPER_ROOT\" && python3 -m http.server) then open http://localhost:8000/sga1/02-converted_html/paper.html"
